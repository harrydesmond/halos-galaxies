#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Jul 17 21:08:58 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THREADS=24
 /usr/local/shared/slurm/bin/srun -u -N 1 --mpi=pmi2 --mem-per-cpu=2000 --ntasks-per-node=24 nice -n 10 /mnt/zfsusers/rstiskalek/src/./19-07-17-CorrScript.py 
