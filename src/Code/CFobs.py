...
galaxy_catalog = np.load("/mnt/zfsusers/rstiskalek/Data/sdss_cutoffV2.npy")
RA, DEC, dist = p.unpack_catalog(galaxy_catalog)
N = RA.size

# Read the supplied randoms catalog
random_catalog = np.load("/mnt/zfsusers/rstiskalek/Data/randCat_matchnsa.npy")
...
km = p.load_pickle("/mnt/zfsusers/rstiskalek/Data/km_clusters.p")
...
# Save the pickles
p.dump_pickle(output, "/mnt/zfsusers/rstiskalek/Data/Obs_CF.p")
p.dump_pickle(wp_out, "/mnt/zfsusers/rstiskalek/Data/Obs_CFsubsamples.p")
