#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Jul 30 09:22:37 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THREADS=14
 /usr/local/shared/slurm/bin/srun -u -N 1 --mpi=pmi2 --mem-per-cpu=7000 --ntasks-per-node=14 nice -n 10 /usr/bin/python3 RandCat.py q
